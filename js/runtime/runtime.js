var now = new Date;
function createtime() {
    var t = new Date("04/01/2025 00:00:00"); now.setTime(now.getTime() + 250);
    ...
    let g = "";
    g = r < 18 && r >= 9 ? `<img class='boardsign' src='https://picx.zhimg.com/80/v2-3602778a69a13bc5650d30a99a89feeb_720w.webp?source=1def8aca' 
